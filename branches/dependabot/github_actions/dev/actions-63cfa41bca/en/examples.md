# Examples - MII IG Dokument v2027.0.0-ballot.2
...
The actor, process and instance tables above are generated by the IG Publisher and render in German: the resource carries English translations for every name and description, but the publisher's ExampleScenario renderer does not yet apply translation extensions. Consumers reading the resource from the package do get the English text.
