...
> **Bei der Migration verfasst — vor dem Release prüfen.** Die Module Person und Fall sind seit dem KDS-Release 2026 im Basismodul (Package `de.medizininformatikinitiative.kerndatensatz.base`) aufgegangen; die Canonical-URLs der referenzierten Profile sind unverändert. Das Diagramm zeigt den von der NSG freigegebenen Stand.
