...
| Active as of 2026-09-05 | *Computable Name*:MII_EX_Dokument_NLP_Processing_Status |
...
All examples are entirely synthetic; the full overview of the module's example instances is on the [Examples](examples.md) page.
