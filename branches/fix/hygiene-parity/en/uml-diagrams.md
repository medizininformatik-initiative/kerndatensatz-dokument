...
> **Written during migration — review before release.** Since the KDS release 2026, the modules Person and Fall have been folded into the base module (package `de.medizininformatikinitiative.kerndatensatz.base`); the canonical URLs of the referenced profiles are unchanged. The diagram shows the state approved by the NSG.
