...
Die Beispiele bilden gemeinsam eine NLP-Verarbeitungskette eines synthetischen Arztbriefs ab (siehe [Anleitung](guidance.md)):

| | | |
| :--- | :--- | :--- |
| [Original-Dokument](DocumentReference-AmandaAlzheimerOriginalDokument.md) | DocumentReference | Original (DOCX) |
| [Klartext-Dokument](DocumentReference-AmandaAlzheimerKlartextDokument.md) | DocumentReference | Klartext-Extraktion |
| [De-identifiziertes Dokument](DocumentReference-AmandaAlzheimerDeIdentifiziertesDokument.md) | DocumentReference | De-Identifikation |
| [Annotiertes Dokument](DocumentReference-AmandaAlzheimerAnnotiertesDokument.md) | DocumentReference | Annotation |
