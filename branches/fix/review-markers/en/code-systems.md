...
The following sections describe the module's own CodeSystems and ValueSets as well as the international terminologies used; licence information on external terminologies is held by the respective publishers (see [Legal notice](index.md#copyright-and-license)).
