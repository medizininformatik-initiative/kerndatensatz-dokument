...
The following table maps the data elements of the logical model [MII LM Dokument](StructureDefinition-mii-lm-dokument.md) onto the elements of this DocumentReference profile.
