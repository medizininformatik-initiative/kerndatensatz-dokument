...
Die unterstützten Suchparameter mit Beispielaufrufen stehen auf der Seite [Suchparameter](search-parameters.md); normativ festgelegt sind sie im [CapabilityStatement des Moduls](CapabilityStatement-mii-cps-dokument-capabilitystatement.md).
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-09-05T12:27:11+00:00",
  "publisher" : "NUM-DIZ",
  "contact" : [{
    "name" : "NUM-DIZ",
    "telecom" : [{
