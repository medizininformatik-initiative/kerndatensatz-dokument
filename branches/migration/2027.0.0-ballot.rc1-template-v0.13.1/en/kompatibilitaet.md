...
| `content.format` | 0..1, Must Support, required | 1..1, Must Support, required | ⚠️ ISiK requires a format code |
...
| `content.attachment.language` | 0..1 | 1..1 | ⚠️ IHE MHD requires the language |
