...
Diese Seite listet die FHIR-Profile des Moduls **Dokument**. Als
...
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatz-dokument/blob/main/docs/recipes/add-a-profile.md) in diesem Repository sowie die
