...
lead decides each one. While a decision is open they are recognisable twice over: the menu
...
3. Replace the template's starter text with the module's real content — the
   banner-free page is now mandatory content like any other.
